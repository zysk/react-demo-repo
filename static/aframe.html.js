...
<body>
	...
	<div id="hero_text">
		...
		<p id="home_text">Welcome to our home. Our home reflects who we are as people. We have curated a range of our work
			for you to explore.</p>
	</div>
	<div id="instructions">
		<p id="click_drag">use arrow keys to move | click + drag to rotate</p>
	</div>
	<a-scene renderer="colorManagement: true; highRefreshRate: true" vr-mode-ui="enabled: false"
		background="color: #ced4da" raycaster="objects: .collidable"
