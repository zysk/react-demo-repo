AFRAME.registerComponent("orb", {
  init: async function () {
    ...
    this.cover_bkg.setAttribute("geometry", {
      primitive: "plane",
      width: 20,
      height: 20,
    })
    this.cover_bkg.setAttribute("material", {
      color: "#ced4da",
      shader: "flat",
      transparent: false,
      opacity: 1.0,
    ...
    let cloud_rotation =
      "property: rotation; from: 0 0 0; to: 0 350 0; dur: 500000; loop: true; easing: linear; direction: alternate; autoplay: true"
    ...
    this.glow.setAttribute("geometry", {
      primitive: "plane",
      width: 2,
      height: 2,
    })
    ...
    let pulse_1 =
      "property: material.opacity; from: 1.0; to: 0.2; dur: 2000; loop: true; dir: alternate; easing: linear;"
    this.glow.setAttribute("animation", pulse_1)

    let projects_btn_prop = {
      align: "center",
      color: "#2971b6",
      value: "VIEW\nPROJECTS",
      fontSize: 0.05,
    ...
    this.home_orb.setAttribute("geometry", {
      primitive: "plane",
      width: 0.65,
      height: 0.65,
    })
    this.home_orb.setAttribute("material", {
      src: glow_src,
      color: "white",
      shader: "standard",
      transparent: true,
    ...
    this.home_orb.addEventListener("click", evt => {
      ...
      let ring_slide_in =
        "property: position; from: 0 1 -4; to: 0 1 -0.03; dur: 4800; loop: false; easing: easeInOutCirc; "
      ...
      let sky_btm_color_change = {
        property: "material.bottomColor",
        to: "#5b5275",
        dur: 3500,
        loop: "false",
      }
      let sky_top_color_change = {
    ...
    let orb_pulse_1 =
      "property: material.opacity; from: 1.0; to: 0.135; dur: 2000; loop: true; dir: alternate; easing: easeInOutCirc;"
    ...
    this.home.setAttribute("material", {
      transparent: true,
      opacity: "0.01",
      blending: "normal",
      emissive: "#e64c4c",
    ...
    this.rings_array.setAttribute("material", {
      color: "#ffab8a",
      opacity: 1,
      depthWrite: false,
      depthTest: false,
  ...
  createProjects: function () {
    ...
    this.projects_info.forEach(project => {
      ...
      thumb_icon.setAttribute("geometry", {
        primitive: "plane",
        width: 0.3,
        height: 0.3,
      })
      thumb_icon.setAttribute("material", {
        src: thumb_icon_src,
        shader: "flat",
        transparent: false,
        opacity: 0.8,
      ...
      let thumb_icon_fade_in = {
        property: "material.opacity",
        from: "0",
        to: ".8",
        dur: 600,
        loop: "false",
        startEvents: "thumb_icon_fade_in",
      }
      let thumb_icon_fade_out = {
        property: "material.opacity",
        from: ".8",
        to: "0",
        dur: 600,
        loop: "false",
        startEvents: "thumb_icon_fade_out",
      }
      ...
      project_txt.setAttribute("position", `0 ${-0.12 - project.radius / 2} 0`)
      ...
      sphere.addEventListener("click", evt => {
        if (!sphere.scaled) {
          ...
          let to_txt = `${to_pos.x} ${0} ${to_pos.z + 0.85}` + ""
      ...
      let project_info = this.createProjectInfo(
        project,
        sphere,
        thumb,
        thumb_icon
  ...
  createProjectInfo: function (info, sphere, thumb, thumb_icon) {
    ...
    btn_container.setAttribute("layout", {
      type: "box",
      columns: 2,
      margin: 0.025,
      align: "center",
    ...
    enter_btn.setAttribute("radius", 0.01)
    ...
    close_btn.setAttribute("radius", 0.01)
  ...
  createOrbs: function () {
    ...
    for (let i = 0; i < numProjects; i += 1) {
      ...
      geometry.setAttribute(
        "geometry",
        "primitive: sphere; thetaLength: 180; radius: .3"
      )
